...
class _AdminLoginScreenState extends ConsumerState<AdminLoginScreen> {
  ...
  bool _selectedCanSendReport = true;
  bool _selectedCanApprove = true;
  ...
  Future<void> _attemptLogin() async {
    ...
    final success = await ref.read(adminProvider.notifier).login(
      ...
      canSendReport: _selectedCanSendReport,
      canApproveOrders: _selectedCanApprove,
    );
    if (success) {
          ...
          children: _admins.asMap().entries.map((entry) {
            ...
            return _AdminButton(
              ...
              onTap: () => setState(() {
                ...
                _selectedCanSendReport = admin.canSendReport;
                _selectedCanApprove = admin.canApproveOrders;
